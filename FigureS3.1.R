...
a<-coreVenn(ZNC_physeq_all,sample_data(ZNC_physeq_all)$species,core_fraction = 0.99,ordered_groups = c('A. marmoratus','A. arizonae','A. neomexicanus'),fill_color = c('red','yellow','orange'))
b<-corePhyloVenn(ZNC_physeq_all,sample_data(ZNC_physeq_all)$species,core_fraction = 0.99,ordered_groups = c('A. marmoratus','A. arizonae','A. neomexicanus'),fill_color = c('red','yellow','orange'),mode='tip')
c<-corePhyloVenn(ZNC_physeq_all,sample_data(ZNC_physeq_all)$species,core_fraction = 0.99,ordered_groups = c('A. marmoratus','A. arizonae','A. neomexicanus'),fill_color = c('red','yellow','orange'))
...
i<-corePhyloVenn(ZNC_physeq_all,sample_data(ZNC_physeq_all)$species,selection='shade',ordered_groups = c('A. marmoratus','A. arizonae','A. neomexicanus'),fill_color = c('red','yellow','orange'))
