...
#Plot relative diversity versus taxonomic rank
axisv<-c(1,2,3,4,5)

par(mar=c(5,5,5,5))
plot(axisv,marmf,col='red',ylim=c(0,10),pch=15,cex=1.875,xlab='Taxonomic Rank',ylab='Relative Diversity',xaxt='n',cex.lab=1.5)
...
#Find max and min phylogenetic diversities across ranks
x = 1:9
...
#Plot maximum variation per method
par(mar=c(7,5,5,1))
plot(1, type="n", xlab="", ylab="Relative Diversity Range", xlim=c(0.5,9.5),
     ylim=c(0, 10),xaxt='n',cex.lab=1.5)
