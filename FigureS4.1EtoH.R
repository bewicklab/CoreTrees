...
par(mar=c(5,5,5,5))
plot(axisv,lkf,col='goldenrod1',ylim=c(0,0.5),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Turnover',xaxt='n',cex.lab=1.5)
...
par(mar=c(5,5,5,5))
plot(axisv,mkf,col='yellow',ylim=c(0,0.6),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Turnover',xaxt='n',cex.lab=1.5)
axis(1, at=1:5, labels=c('ASV','species','genus','family','order'))
...
plot(axisv,nkf,col='khaki1',ylim=c(0,1),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Turnover',xaxt='n',cex.lab=1.5)
