...
par(mar=c(5,5,5,5))
plot(axisv,lkf,col='goldenrod1',ylim=c(0.6,1),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Relative Diversity',xaxt='n',cex.lab=1.5)
...
par(mar=c(5,5,5,5))
plot(axisv,mkf,col='yellow',ylim=c(0.6,1.2),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Relative Diversity',xaxt='n',cex.lab=1.5)
axis(1, at=1:5, labels=c('ASV','species','genus','family','order'))
...
plot(axisv,nkf,col='khaki1',ylim=c(0,2.),pch=15,cex=1.5,xlab='Taxonomic Rank',ylab='Relative Diversity',xaxt='n',cex.lab=1.5)
...
plot(1, type="n", xlab="", ylab="Relative Diversity Range", xlim=c(0.5,18.5),
     ylim=c(0, 2),xaxt='n',cex.lab=1.25)
