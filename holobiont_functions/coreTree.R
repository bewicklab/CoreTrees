...
#' @export
coreTree <- function(x, core_fraction = 0.5, ab_threshold1 = 0, ab_threshold2 = 0, ab_threshold3 = 0, mode = 'branch', selection = 'basic', max_tax=NULL, increase_cutoff = 2, NCcol = 'black',Ccol='red',rooted=TRUE,branch.width=4,label.tips=FALSE, remove_zeros=TRUE,plot.chronogram=FALSE) {
  ...
  if (mode=='branch'){
    ...
    #Call function to calculate all edges and core edges
      ...
      temp<-shade_branch(x,newtree,max_tax,increase_cutoff)
